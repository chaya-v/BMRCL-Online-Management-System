...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="login.php"><strong>Login<span class="sr-only">(current)</span></strong></a>
      </li>
      <li class="nav-item">
  ...
  <div class = "wrapper">
    <h3 style="text-align: center; color: white;"><strong>Admin Login</strong></h3>
   <form action="php/admin_login_check.php" id="loginForm" method="POST">
